...
Bruit_De_Voiture = pygame.mixer.Sound("indice1/bruit de voiture.wav")

Klaxon = pygame.mixer.Sound("indice1/klaxon.wav")

Bruit_applaudissement = pygame.mixer.Sound("indice1/applaudissement.wav")

Bruit_de_crash = pygame.mixer.Sound("indice1/crache.wav")
...
route = pygame.image.load("indice1/route.png")
route.convert()

arrivee = pygame.image.load("indice1/arrivee.jpg")
arrivee.convert()
arrivee_rect= arrivee.get_rect(center=(830,347))

voiture1 = pygame.image.load("indice1/voiture1.png")
voiture1.convert()
voiture1_rect = voiture1.get_rect(center=(70,217))

voiture2 = pygame.image.load("indice1/voiture2.png")
voiture2.convert()
voiture2_rect = voiture2.get_rect(center=(70,497))

voiture3 = pygame.image.load("indice1/voiture3.jpg")
voiture3.convert()

voiture4 = pygame.image.load("indice1/voiture4.jpg")
voiture4.convert()

tete_de_mort = pygame.image.load("indice1/tete de mort.jpg")
tete_de_mort.convert()

victoire_fond = pygame.image.load("indice1/victoire_fond.jpg")
victoire_fond.convert()

cadre = pygame.image.load("indice1/cadre.png")
cadre.convert()

fond = pygame.image.load("indice1/fond.jpg")
fond.convert()

fond2 = pygame.image.load("indice1/fond2.jpg")
fond2.convert()

croix = pygame.image.load("indice1/croix.png")
croix.convert()

dossier = pygame.image.load("indice1/dossier.png")
dossier.convert()

ecran_ordi = pygame.image.load("indice1/ecran_ordi.png")
ecran_ordi.convert()

ecran_contour = pygame.image.load("indice1/ecran_contour.png")
ecran_contour.convert()

last = pygame.image.load("indice1/last.png")
last.convert()
...
def Menu(screen):
    ...
    while bouton:
        ...
        screen.blit(start, (230, 95))
        screen.blit(bouton_start, (365, 345))
        screen.blit(bouton_stop, (392, 405))
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                pygame.quit()
...
def Perdu(screen):
    ...
    screen.blit(Titre_Perdu,(175,95))
    screen.blit(tete_de_mort,(295,195))
    pygame.display.flip()
    time.sleep(3)
    Menu(screen)
